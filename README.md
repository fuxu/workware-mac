...
- [Vim](https://www.vim.org/) - Vim 古老的终端中使用的编辑器。
...
- [MacDown](https://macdown.uranusjr.com/) - 一款开源的 Markdown 编辑器，深受 Mou 的影响。
...
- [有道云笔记](https://note.youdao.com/) - 支持多目录，Markdown，iWork/Office 预览。
- [为知笔记](https://www.wiz.cn/download.html) - 支持 Markdown，搜集整理图片链接导入文档。
...
- [DiffMerge](https://sourcegear.com/diffmerge/) - 可视化的文件比较（也可进行目录比较）与合并工具。
...
- [iTerm2](https://iterm2.com/) - 免费的终端工具，直接替代自带的 Terminal，有非常多惊人的特性。
...
- [Virtual Box](https://www.virtualbox.org/) - 免费、免费、免费，带 NTFS 读写，不用买 ParagonNTFS，省100块。

### 数据库

- [Another-RDM](https://gitee.com/qishibo/AnotherRedisDesktopManager) - 免费，更快、更好、更稳定的 Redis 桌面（ GUI ）管理客户端
- [MySQL Workbench](https://dev.mysql.com/downloads/workbench/) - MySQL 数据库官方管理软件。
- [Sequel Pro](https://www.sequelpro.com/) - 一个 MySQL 数据库管理软件。
- [medis](https://getmedis.com/) - 漂亮的 Redis 管理软件。
...
- [迅雷](https://www.xunlei.com/) - Mac 版迅雷。
...
- [Safari](https://www.apple.com.cn/safari/) - Mac 预装自带浏览器。
- [Chrome](https://www.google.cn/chrome/) - Chrome 浏览器谷歌出品。
- [Microsoft Edge](https://www.microsoft.com/zh-cn/edge/home) - 微软出品，基于 Chromium 内核，安装插件无需翻墙，支持多端同步
- [Firefox](https://www.firefox.com.cn/) - 选择会保护重要数据的浏览器

## 翻译工具

- [火山翻译](https://translate.volcengine.com/translate) - 心脏和字节，只有一个能跳动的翻译软件，不会把 Spring 翻译为春天
- [有道翻译](https://cidian.youdao.com/) - 有道词典桌面版。
- [海词词典](https://cidian.haidii.com/mac.html) - 学单词、背单词、真人发音、单词详解...
- [DeepL](https://www.deepl.com/translator) - 一家创业公司推出的机器翻译引擎，据称比谷歌翻译得更好。
- [eudic](https://www.eudic.net/eudic/mac_dictionary.aspx) - 欧路词典词典。
- [Grammarly](https://app.grammarly.com/) - 修正英语语法及用语。
- [iText](https://toolinbox.net/iText/) - 截图识别文字、翻译。
- [iTranslate](https://itranslate.com/) - 支持全世界超过 100 种语言发音和输出。
